...
public class EditPersonalInfoTest {
    ...
    public void editPersonalDetails() {
        ...
        system.getEditPersonalInfo().editPersonalDetails(fan, "Avi", "Levi", "0544884666", "Yuda123", "");
        Fan checkFan = (Fan)system.getDatabase().getUser(fan.getID());
        assertEquals(checkFan.getPhone(), "0544884666"); ///
        system.getEditPersonalInfo().editPersonalDetails(fan, "Avi", "Levi", "0544884666", "Yuda123", "ABC123");
    ...
    public void editPersonalDetails1() {
        ...
        system.getEditPersonalInfo().editPersonalDetails(player, "leo", "mesi", "AAA123");
